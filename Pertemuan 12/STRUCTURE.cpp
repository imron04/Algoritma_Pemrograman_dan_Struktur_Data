/*
1. Implementasi Struct Sederhana 
#include <iostream>
using namespace std;
...
-------------------------------------
2. Implemewntasi Cara Mengakses Member dalam Struct 
#include <iostream>
#include <string>
using namespace std;
...
-------------------------------
3. Implementasi Cara Menginisialisasikan Objek ke Dalam Struct
#include <iostream>
#include <string>
using namespace std;
...
5 Implementasi Struct dengan Array
...
----------------------------------------------
6 Implementasi Struct dengan Function
